// From https://github.com/okadan/nfc-manager/blob/master/lib/model/record.dart
...
abstract class NfcRecord {
  NdefRecord toNdef();

  static NfcRecord fromNdef(NdefRecord record) {
    if (record.typeNameFormat == NdefTypeNameFormat.nfcWellknown &&
        record.type.length == 1 &&
        record.type.first == 0x54) {
      return WellknownTextNfcRecord.fromNdef(record);
    }
    if (record.typeNameFormat == NdefTypeNameFormat.nfcWellknown &&
        record.type.length == 1 &&
...
class WellknownTextNfcRecord implements NfcRecord {
  ...
  static WellknownTextNfcRecord fromNdef(NdefRecord record) {
...
class WellknownUriRecord implements NfcRecord {
...
class MimeRecord implements NfcRecord {
...
class UnsupportedRecord implements NfcRecord {
